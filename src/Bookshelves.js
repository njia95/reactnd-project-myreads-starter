...
class BookShelves extends React.Component {
  ...
  render() {
    ...
    const shelves = [
      { "title": "Currently Reading", "name": "present" },
      { "title": "Want to Read", "name": "future" },
      { "title": "Read", "name": "past" }
    ]
    ...
    return (
      <div className="list-books">
        ...
        <div className="list-books-content">
            {shelves.map(shelf => (
              <Bookshelf key={shelf.title} title={shelf.title} books={books.filter(book => book.shelve === shelf.name)} />
            ))}
        </div>
